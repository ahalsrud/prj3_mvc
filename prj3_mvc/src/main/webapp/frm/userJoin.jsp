...
<title>MOVIEPLANET-회원가입</title>
    ...
    <link href="http://localhost/prj3_mvc/css/" rel="stylesheet" type="text/css" />
    <link href="http://localhost/prj3_mvc/css/common-sv-202006161246.css" rel="stylesheet" type="text/css" />
    <link href="http://localhost/prj3_mvc/css/join-sv-202203141106.css" rel="stylesheet" type="text/css" />
				...
				<form action="join_process.do" name="joinFrm" id="joinFrm" method="post">
					...
					<div class="row_group mbr_info">
						...
						<div class="row mbr_name">
							...
							<div class="col_2">
								<input type="text" id="user_id" name="user_id" placeholder="아이디" maxlength="12">
								<div class="notice_msg" id="notice_msg_name"></div>
							</div>
						</div>
						<div class="row mbr_name">
							...
							<div class="col_2">
								<input type="text" id="nick_name" name="nick_name" placeholder="닉네임" maxlength="12">
								<div class="notice_msg" id="notice_msg_name"></div>
							</div>
						</div>
						...
						<div class="row mbr_email">
							...
							<div class="col_2">
								<input type="text" id="email" name="email" placeholder="이메일" class="mbr_email_id dev-mail" size="8" maxlength="30">
